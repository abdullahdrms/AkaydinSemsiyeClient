...
import UserCreateModal from 'sections/settings/UserCreateModal';
import UserUpdateModal from 'sections/settings/UserUpdateModal';
import UserRoleModal from 'sections/settings/UserRoleModal';

// ==============================|| REACT TABLE - LIST ||============================== //
const fallbackData = [];
function ReactTable({ data, columns, pagination, setPagination, setSorting, sorting, globalFilter, setGlobalFilter, setUserAddModal }) {
      ...
      <MainCard content={false}>
        <Stack direction="row" spacing={2} alignItems="center" justifyContent="space-between" sx={{ padding: 3 }}>
          ...
          <Stack direction="row" alignItems="center" spacing={2}>
            <Button variant="contained" startIcon={<Add />} onClick={() => { setUserAddModal(true); }} size="large">
              Kullanıcı Ekle
            </Button>
          </Stack>
        </Stack>
...
export default function OrderList() {
  ...
  let breadcrumbLinks = [{ title: 'Kullanıcı Ayarları' }, { title: 'Kullanıcılar', to: `/settings/user-list` }];
  ...
  return (
    <>
      ...
      <UserCreateModal setIsEdit={setIsEdit} open={userAddModal} modalToggler={setUserAddModal} />
      <UserUpdateModal selectedUser={selectedUser} setIsEdit={setIsEdit} open={userUpdateModal} modalToggler={setUserUpdateModal} />
      <UserRoleModal customerId={customerId} setIsEdit={setIsEdit} open={userRoleModal} modalToggler={setUserRoleModal} />
    </>
  );
}