...
import DepartmentsAddModal from 'sections/employees/DepartmentsAddModal';
import DepartmentsUpdateModal from 'sections/employees/DepartmentsUpdateModal';

// ==============================|| REACT TABLE - LIST ||============================== //
const fallbackData = [];
function ReactTable({ data, columns, pagination, setPagination, setSorting, sorting, globalFilter, setGlobalFilter, setDepartmentsAddModal }) {
            ...
            <MainCard content={false}>
                <Stack direction="row" spacing={2} alignItems="center" justifyContent="space-between" sx={{ padding: 3 }}>
                    ...
                    <Stack direction="row" alignItems="center" spacing={2}>
                        <Button variant="contained" startIcon={<Add />} onClick={() => { setDepartmentsAddModal(true) }} size="large">
                            Departman Ekle
                        </Button>
                    </Stack>
                </Stack>
...
export default function DepartmentsList() {
    ...
    const [departmentsAddModal, setDepartmentsAddModal] = useState(false)
    const [departmentsUpdateModal, setDepartmentsUpdateModal] = useState(false)
                        ...
                        <Stack direction="row" spacing={0}>
                            ...
                            <Tooltip title="Edit">
                                <IconButton
                                    ...
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        setDepartmentsUpdateModal(true)
                                    }}
                                >
                                    <Edit />
                                </IconButton>
    ...
    let breadcrumbLinks = [{ title: 'Personel Yönetimi' }, { title: 'Departmanlar', to: `/employees/departments` }];
    ...
    return (
        <>
            ...
            <DepartmentsAddModal open={departmentsAddModal} modalToggler={setDepartmentsAddModal} />
            <DepartmentsUpdateModal open={departmentsUpdateModal} modalToggler={setDepartmentsUpdateModal} />
        </>
    );
}