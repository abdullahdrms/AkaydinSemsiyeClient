...
import { CreateEcoUmbrella, GetOrderDetail, UpdateEcoUmbrella } from 'services/ordersServices';
...
export default function EcoProduct({ update = false }) {
    ...
    let breadcrumbLinks = [{ title: 'Sipariş Yönetimi', to: '/orders/list' }, { title: 'Detay', to: `/orders/detail/${data?.orderId}` }, { title: 'Ürün Detayı', to: `/orders/detail/product-detail/${updateOrderId}` }, { title: 'Ürün Düzenle' }, { title: 'Mekanizmalı Ekonomik Şemsiye', }]
                                                                ...
                                                                <>
                                                                    <Grid item marginBottom={3} xs={12} lg={8}>
                                                                        ...
                                                                        <Autocomplete
                                                                            ...
                                                                            value={localColors?.find((item) => parseInt(item?.id) === parseInt(formik.values.localColor))}
                                                                            renderInput={(params) => <TextField {...params} label="Lütfen Yerli Renk Seçiniz" />}
                                                                        />
                                                                    </Grid>
                                                                    <Grid item xs={12} lg={4} >
                                                                        <Box component="section" sx={{ width: '100%', height: '258px', cursor: 'pointer', borderRadius: 1, border: '1px dashed grey', '&:hover': { bgcolor: '#f1faff', borderColor: '#009ef7' } }}>
                                                    ...
                                                    <Grid container spacing={3}>
                                                        <Grid item lg={3} xs={12}>
                                                            <Box onClick={() => setFieldValue('heater', "1")} component="section" sx={{ p: 2, pl: 2, width: '100%', cursor: 'pointer', borderRadius: 1, border: `1px dashed ${errors.heater ? '#dc2626' : 'grey'}`, marginRight: 3, '&:hover': { bgcolor: '#f1faff', borderColor: '#009ef7' } }}>
                                                                <label>
                                                                    <span>
                                                                        <input style={{ width: '20px', height: '20px' }} value="1" checked={formik.values.heater === "1" ? true : false} onChange={(e) => setFieldValue('heater', "1")} name='radio-curtain' type="radio" />
                                                                    </span>
                                                                    <span style={{ position: 'relative', bottom: '4px', left: '6px' }}>
                                                                        Yok
                                                                    </span>
                                                        ...
                                                        <Grid item lg={3} xs={12}>
                                                            <Box onClick={() => setFieldValue('heater', "2")} component="section" sx={{ p: 2, pl: 2, width: '100%', cursor: 'pointer', borderRadius: 1, border: `1px dashed ${errors.heater ? '#dc2626' : 'grey'}`, '&:hover': { bgcolor: '#f1faff', borderColor: '#009ef7' } }}>
                                                                <label htmlFor="">
                                                                    <span>
                                                                        <input style={{ width: '20px', height: '20px' }} value="2" checked={formik.values.heater === "2" ? true : false} onChange={(e) => setFieldValue('heater', "2")} name='radio-curtain' type="radio" />
                                                                    </span>
                                                                    <span style={{ position: 'relative', bottom: '4px', left: '6px' }}>
                                                                        Var
                                                                    </span>
                                            ...
                                            <>
                                                <Grid marginBottom={3} item xs={12}>
                                                    ...
                                                    <TextField
                                                        ...
                                                        error={Boolean(touched.heaterQty && errors.heaterQty)}
                                                        helperText={touched.heaterQty && errors.heaterQty}
                                                    />
                                                </Grid>
                                                <Grid item xs={12}>
                                                    <div style={{ marginLeft: '2px', marginBottom: '10px', marginTop: '26px', color: '#5B6B79' }}>
