...
const getInitialValues = ({ data, update }) => {
    ...
    const updateOrder = {
        ...
        curtainQty: `${data?.curtainQty}` || "",
        curtainText: `${data?.curtainText === null ? "" : data?.curtainText}` || "",
...
export default function KamelyaProduct({ update = false }) {
    ...
    const VillaSchema = Yup.object().shape({
        ...
        shapeSizeType: Yup.string().test("isValid", "Bu alan zorunlu", (value) => {
            if (parseInt(formik.values.shape) === 1) {
                if (parseInt(value) === 3 || parseInt(value) === 4 || parseInt(value) === 5) {
                    return true
                } else {
                    return false
                }
        ...
        curtain: Yup.string().required('bu alan zorunlu'),
        curtainText: Yup.string().test("isValid", "Bu alan zorunlu", (value) => {
            if (parseInt(formik.values.curtain) === 2) {
                if (formik.values.curtainText !== "") {
                    return true
                } else {
                    return false
                }
        ...
        curtainQty: Yup.string().test("isValid", "Bu alan zorunlu", (value) => {
            if (parseInt(formik.values.curtain) === 2) {
                if (parseInt(value) > 0) {
                    return true
                } else {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { setSubmitting }) => {
            try {
                ...
                fd.append("Curtain", formik.values.curtain)
                if (parseInt(formik.values.curtain) === 2) {
                    fd.append("CurtainQty", formik.values.curtainQty)
                    ...
                    <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
                        <DialogContent sx={{ p: 2.5 }}>
                            <Grid item xs={12} md={12}>
                                        ...
                                        <Grid marginBottom={3} item xs={12}>
                                            ...
                                            <FormControl style={{ width: '100%' }} component="fieldset">
                                                <RadioGroup id='standType' name="radio-standType" row>
                                                    <Grid container spacing={3}>
                                                        <Grid item lg={3} xs={12}>
                                                            <Box onClick={() => setFieldValue('standType', "7")} component="section" sx={{ p: 2, pl: 2, width: '100%', cursor: 'pointer', borderRadius: 1, border: `1px dashed ${errors.standType ? '#dc2626' : 'grey'}`, marginRight: 3, '&:hover': { bgcolor: '#f1faff', borderColor: '#009ef7' } }}>
                                                                <label>
                                                                    <span>
                                                ...
                                                </Grid>
                                                {
                                                    ...
                                                    <Grid item xs={12}>
                                                        ...
                                                        <TextField
                                                            ...
                                                            error={Boolean(errors.ledText)}
                                                            helperText={errors.ledText}
                                                        />
                                                    </Grid>
                                                }
                                            </>
                                ...
                                <Grid style={{ marginBottom: '12px' }} item xs={12}>
                                    <MainCard title='Perde Seçimi'>
                                        <Grid marginBottom={3} item xs={12}>
                                            <InputLabel style={{ marginBottom: '20px', marginTop: '16px' }}>Perde</InputLabel>
                                            <FormControl style={{ width: '100%' }} component="fieldset">
                                                <RadioGroup id='curtain' name="radio-curtain" row>
                                                    <Grid container spacing={3}>
                                                        <Grid item lg={3} xs={12}>
                                                            <Box onClick={() => setFieldValue('curtain', "1")} component="section" sx={{ p: 2, pl: 2, width: '100%', cursor: 'pointer', borderRadius: 1, border: `1px dashed ${errors.curtain ? '#dc2626' : 'grey'}`, marginRight: 3, '&:hover': { bgcolor: '#f1faff', borderColor: '#009ef7' } }}>
                                                                <label>
                                                                    <span>
                                                                        <input style={{ width: '20px', height: '20px' }} value="1" checked={formik.values.curtain === "1" ? true : false} onChange={(e) => setFieldValue('curtain', "1")} name='radio-curtain' type="radio" />
                                                                    </span>
                                                                    <span style={{ position: 'relative', bottom: '4px', left: '6px' }}>
                                                                        Yok
                                                                    </span>
                                                        ...
                                                        <Grid item lg={3} xs={12}>
                                                            <Box onClick={() => setFieldValue('curtain', "2")} component="section" sx={{ p: 2, pl: 2, width: '100%', cursor: 'pointer', borderRadius: 1, border: `1px dashed ${errors.curtain ? '#dc2626' : 'grey'}`, '&:hover': { bgcolor: '#f1faff', borderColor: '#009ef7' } }}>
                                                                <label htmlFor="">
                                                                    <span>
                                                                        <input style={{ width: '20px', height: '20px' }} value="2" checked={formik.values.curtain === "2" ? true : false} onChange={(e) => setFieldValue('curtain', "2")} name='radio-curtain' type="radio" />
                                                                    </span>
                                                                    <span style={{ position: 'relative', bottom: '4px', left: '6px' }}>
                                                                        Var
                                                                    </span>
                                        ...
                                        {
                                            parseInt(formik.values.curtain) === 2 &&
                                            <>
                                                <Grid marginBottom={3} item xs={12}>
                                                    <InputLabel style={{ marginBottom: '20px', marginTop: '36px' }}>Adet</InputLabel>
                                                    <FormControl style={{ width: '100%' }} component="fieldset">
                                                        <RadioGroup id='curtainQty' name="radio-curtainQty" row>
                                                            <Grid container spacing={3}>

                                                                <Grid item lg={3} xs={12}>
                                                                    <Box onClick={() => setFieldValue('curtainQty', "1")} component="section" sx={{ p: 2, pl: 2, width: '100%', cursor: 'pointer', borderRadius: 1, border: `1px dashed ${errors.curtainQty ? '#dc2626' : 'grey'}`, marginRight: 3, '&:hover': { bgcolor: '#f1faff', borderColor: '#009ef7' } }}>
                                                                        <label>
                                                                            <span>
                                                                                <input style={{ width: '20px', height: '20px' }} value="1" checked={formik.values.curtainQty === "1" ? true : false} onChange={(e) => setFieldValue('curtainQty', "1")} name='radio-curtainQty' type="radio" />
                                                                            </span>
                                                                            <span style={{ position: 'relative', bottom: '4px', left: '6px' }}>
                                                                                1 Adet
                                                                            </span>
                                                                ...
                                                                <Grid item lg={3} xs={12}>
                                                                    <Box onClick={() => setFieldValue('curtainQty', "2")} component="section" sx={{ p: 2, pl: 2, width: '100%', cursor: 'pointer', borderRadius: 1, border: `1px dashed ${errors.curtainQty ? '#dc2626' : 'grey'}`, '&:hover': { bgcolor: '#f1faff', borderColor: '#009ef7' } }}>
                                                                        <label htmlFor="">
                                                                            <span>
                                                                                <input style={{ width: '20px', height: '20px' }} value="2" checked={formik.values.curtainQty === "2" ? true : false} onChange={(e) => setFieldValue('curtainQty', "2")} name='radio-curtainQty' type="radio" />
                                                                            </span>
                                                                            <span style={{ position: 'relative', bottom: '4px', left: '6px' }}>
                                                                                2 Adet
                                                                            </span>
                                                                ...
                                                                <Grid item lg={3} xs={12}>
                                                                    <Box onClick={() => setFieldValue('curtainQty', "3")} component="section" sx={{ p: 2, pl: 2, width: '100%', cursor: 'pointer', borderRadius: 1, border: `1px dashed ${errors.curtainQty ? '#dc2626' : 'grey'}`, '&:hover': { bgcolor: '#f1faff', borderColor: '#009ef7' } }}>
                                                                        <label htmlFor="">
                                                                            <span>
                                                                                <input style={{ width: '20px', height: '20px' }} value="3" checked={formik.values.curtainQty === "3" ? true : false} onChange={(e) => setFieldValue('curtainQty', "3")} name='radio-curtainQty' type="radio" />
                                                                            </span>
                                                                            <span style={{ position: 'relative', bottom: '4px', left: '6px' }}>
                                                                                3 Adet
                                                                            </span>
                                                                ...
                                                                <Grid item lg={3} xs={12}>
                                                                    <Box onClick={() => setFieldValue('curtainQty', "4")} component="section" sx={{ p: 2, pl: 2, width: '100%', cursor: 'pointer', borderRadius: 1, border: `1px dashed ${errors.curtainQty ? '#dc2626' : 'grey'}`, '&:hover': { bgcolor: '#f1faff', borderColor: '#009ef7' } }}>
                                                                        <label htmlFor="">
                                                                            <span>
                                                                                <input style={{ width: '20px', height: '20px' }} value="4" checked={formik.values.curtainQty === "4" ? true : false} onChange={(e) => setFieldValue('curtainQty', "4")} name='radio-curtainQty' type="radio" />
                                                                            </span>
                                                                            <span style={{ position: 'relative', bottom: '4px', left: '6px' }}>
                                                                                4 Adet
                                                                            </span>
                                                ...
                                                <Grid item xs={12}>
                                                    ...
                                                    <TextField
                                                        ...
                                                        multiline
                                                        rows={5}
                                                        placeholder="Perde Açıklaması"
                                                        {...getFieldProps('curtainText')}
                                                        error={Boolean(touched.curtainText && errors.curtainText)}
                                                        helperText={touched.curtainText && errors.curtainText}
                                                    />
                                                </Grid>
                                            </>
                                        }
