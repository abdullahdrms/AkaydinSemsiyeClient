...
export default function IncomeAreaChart({ slot = 'month', quantity = 'By volume', yearOrderCount }) {
    ...
    switch (quantity) {
      case 'By volume':
        setSeries([
          {
            name: 'Toplam Satış',
            data: yearOrderCount.map((item) => item?.orderCount)
          }
        ]);
        break;
