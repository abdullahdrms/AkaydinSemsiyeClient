...
import { createStock, updateStock } from 'services/stockServices';
...
export default function StockCreateForm({ closeModal, setIsEdit, selectedStock }) {
            ...
            <FormikProvider value={formik}>
                <LocalizationProvider dateAdapter={AdapterDateFns}>
                    <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
                        <DialogTitle>{selectedStock !== undefined ? "Stok Düzenle" : "Stok Ekle"}</DialogTitle>
                        <Divider />
