...
import { getMonthlyStats } from 'services/statServices'
                ...
                <Stack direction="row" spacing={2} alignItems="center" justifyContent="flex-end" sx={{ padding: 3 }}>
                    <Grid item marginBottom={2} marginTop={2} xs={2}>
                        <Autocomplete
                            ...
                            defaultValue={new Date().getMonth() + 1 > 9 ? `${new Date().getMonth() + 1}` : `0${new Date().getMonth() + 1}`}
                            renderInput={(params) => <TextField label="Ay" {...params} />}
                        />
                    </Grid>
                    <Grid item marginBottom={2} marginTop={2} xs={2}>
                        <Autocomplete
